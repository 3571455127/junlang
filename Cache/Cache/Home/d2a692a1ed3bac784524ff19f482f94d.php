                    ...
                    <div class="row">
                        <div class="clearfix">
                            <div class="left col-lg-6 col-md-6">
                                ...
                                <div class="share">
                                    <ul class="clearfix">
                                        <li class="linkedin"><a href="<?php echo ($ins); ?>" title=""
                                                target="_blank" rel="nofollow"><img src="__PUBLIC__/www/images/linkedin.png"
                                                    alt=""></a>
                                        </li>
                                        <li class="twitter"><a href="<?php echo ($twitter); ?>" title=""
                                                target="_blank" rel="nofollow"><img src="__PUBLIC__/www/images/twitter.png" alt=""></a>
                                        </li>
                                        <li class="whatsapp"><a href="<?php echo ($Whatsapp); ?>" title=""
                                                target="_blank" rel="nofollow"><img src="__PUBLIC__/www/images/whatsapp.png"
                                                    alt=""></a>
                                        </li>
                                        <li class="skype"><a href="<?php echo ($Skype); ?>" title=""
                                                target="_blank" rel="nofollow"><img src="__PUBLIC__/www/images/skype.png" alt=""></a>
                                        </li>
                                        <li class="youtube"><a href="<?php echo ($youtube); ?>" title=""
                                                target="_blank" rel="nofollow"><img src="__PUBLIC__/www/images/youtube.png" alt=""></a>
                                        </li>
                                        <li class="facebook"><a href="<?php echo ($facebook); ?>" title=""
                                                target="_blank" rel="nofollow"><img src="__PUBLIC__/www/images/facebook.png"
                                                    alt=""></a>
                                        </li>
                                    </ul>
                                </div>
